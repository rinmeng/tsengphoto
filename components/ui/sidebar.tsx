  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        hover:text-sidebar-accent-foreground absolute top-3.5 right-3 flex aspect-square
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1
        flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden
